...
| `(main)` | `/admin/users` | 플랫폼 사용자 관리 |
| `(main)` | `/admin/workspaces` | 플랫폼 워크스페이스 관리 |
| `(main)` | `/admin/audit-logs` | 플랫폼 감사 로그 |
...
| UserManagement | `src/components/admin/UserManagement.tsx` | 플랫폼 사용자 관리 |
| WorkspaceManagement | `src/components/admin/WorkspaceManagement.tsx` | 플랫폼 워크스페이스 관리 |
| AuditLogViewer | `src/components/admin/AuditLogViewer.tsx` | 플랫폼 감사 로그 뷰어 |
